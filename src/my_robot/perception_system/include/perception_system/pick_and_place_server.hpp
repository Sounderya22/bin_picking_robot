...
{
public:
  explicit URPickPlace(const rclcpp::NodeOptions & options = rclcpp::NodeOptions())
      ...
      visual_tools_("base_link")
  {
    ...
    client_ = this->create_client<gazebo_msgs::srv::GetModelState>("get_model_state");
