...
def generate_launch_description():
    ...
    pkg_box_bot_gazebo = get_package_share_directory("office_gazebo")

    # Add to path the models for Ingestors and Digestors
    extra_models_package = "office_gazebo"
    ...
    autogen_models_package = "office_gazebo"
    autogen_models_package_path = get_package_share_directory(autogen_models_package)
    ...
    if "GAZEBO_PLUGIN_PATH" in os.environ:
        os.environ["GAZEBO_PLUGIN_PATH"] = (
            ...
            + "/lib"
            + ":"
            + gazebo_ros2_control_path_install_dir
            + "/lib"
        )
    else:
        os.environ["GAZEBO_PLUGIN_PATH"] = (
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                "world",
                default_value=[
                    os.path.join(pkg_box_bot_gazebo, "worlds", "starbots_complete.world"),
                    "",
                ],
