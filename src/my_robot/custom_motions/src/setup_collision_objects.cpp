...
int main(int argc, char * argv[])
{
  ...
  auto const collision_object = [frame_id = arm_group_interface.getPlanningFrame(), &node, &logger] {
    ...
    // Create collision object for the robot to avoid
  auto const collision_object_2 = [frame_id = arm_group_interface.getPlanningFrame(), &node, &logger] {
    ...
    // Create collision object for the robot to avoid
  auto const collision_object_3 = [frame_id = arm_group_interface.getPlanningFrame(), &node, &logger] {
    ...
    return collision_object;
      ...
      // Create collision object for the robot to avoid
  auto const collision_object_4 = [frame_id = arm_group_interface.getPlanningFrame(), &node, &logger] {
